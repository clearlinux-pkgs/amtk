...
Source0  : https://download.gnome.org/sources/amtk/5.3/amtk-5.3.2.tar.xz
...
%prep
%setup -q -n amtk-5.3.2
cd %{_builddir}/amtk-5.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1650383978
...
cp %{_builddir}/amtk-5.3.2/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/amtk/757b86330df80f81143d5916b3e92b4bcb1b1890
