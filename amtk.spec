...
Version  : 5.4.0
Release  : 11
URL      : https://download.gnome.org/sources/amtk/5.4/amtk-5.4.0.tar.xz
Source0  : https://download.gnome.org/sources/amtk/5.4/amtk-5.4.0.tar.xz
...
%prep
%setup -q -n amtk-5.4.0
cd %{_builddir}/amtk-5.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651611620
...
cp %{_builddir}/amtk-5.4.0/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/amtk/757b86330df80f81143d5916b3e92b4bcb1b1890
