...
Source0  : https://download.gnome.org/sources/amtk/5.6/amtk-5.6.0.tar.xz
...
%prep
%setup -q -n amtk-5.6.0
cd %{_builddir}/amtk-5.6.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667445069
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libamtk-5.so.1
/usr/lib64/libamtk-5.so.1.0.1
